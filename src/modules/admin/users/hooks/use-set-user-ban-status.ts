...
export const useSetUserBanStatus = (
  options?: MutationOptions<ApiSuccessResponse<string>, SetUserBanStatusInput>,
) => {
  ...
  return useMutation({
    ...options,
    mutationFn: (data: SetUserBanStatusInput) => setUserBanStatus(data),
    onMutate: async (data) => {
